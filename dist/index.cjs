...
function markdownLoader(specRegistry = new core.SpecRegistry()) {
    var _a, _b;
...
function todoListMarkdownItPlugin(md, options = {}) {
    ...
    function getChildren(tokens, position) {
        ...
        utils.assertNotUndefined(parentOpen, 'parentOpen cannot be undefined');
...
const getDefaultMarkdownItTokenizer = () => markdownIt__default["default"]().use(todoListMarkdownItPlugin).use(tableMarkdownItPlugin);
function markdownParser(specRegistry = new core.SpecRegistry(), markdownItTokenizer = getDefaultMarkdownItTokenizer()) {
    const { tokens } = markdownLoader(specRegistry);
    return new prosemirrorMarkdown.MarkdownParser(specRegistry.schema, markdownItTokenizer, tokens);
}
...
const markdownSerializer = (specRegistry) => {
    ...
    return new prosemirrorMarkdown.MarkdownSerializer(serializer.node, serializer.mark);
};

exports.getDefaultMarkdownItTokenizer = getDefaultMarkdownItTokenizer;
exports.inlineNodeParser = inlineNodeParser;
exports.markdownParser = markdownParser;
exports.markdownSerializer = markdownSerializer;
exports.todoListMarkdownItPlugin = todoListMarkdownItPlugin;
